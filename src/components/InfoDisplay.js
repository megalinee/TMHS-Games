            ...
            <currentGame.Consumer>
                {({ game, updateGame }) => (
                    <div style={{ height: height, transition: 'width 0.5s 0.5s, height 0.5s 0.5s, opacity 0.5s;' }}>
                        <div style={{ transition: 'all .2s ease', zIndex: -2, backgroundImage: `url("/static/images/cards/${game.id}/${game.id}.png")` }} className="bg-blurred-image"></div>
                        ...
                        <Grid container spacing={2} justify="center" style={{ zIndex: .5, position: "absolute", top: '0%' }}>
                            ...
                            <Grid item sm={7} style={{ marginTop: "10%" }}>
                                ...
                                <Paper style={{ backgroundColor: 'rgba(0,0,0,0.9)', marginLeft: '20px', paddingRight: '20px', display: 'inline-table' }} elevation={2}>
                                    <p style={{ fontSize: '25px', marginLeft: '20px' }}>{game.description}</p>
                                </Paper>
                                <Spacer size="2vh"></Spacer>
                                <Paper style={{ backgroundColor: 'rgba(0,0,0,0.9)', marginLeft: '20px', paddingRight: '20px', display: 'inline-table', lineHeight: '0' }} elevation={2}>
